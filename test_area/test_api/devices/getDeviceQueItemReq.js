...
function getDeviceQueueItemsRequest_to_chirpstack(devEUI) {
  // Create a request to get device queue items.
  ...
  deviceService.getQueue(createReq, metadata, (err, resp) => {
    ...
    console.log('Get Queue Device items has been compleled.');
  });
}

getDeviceQueueItemsRequest_to_chirpstack("");