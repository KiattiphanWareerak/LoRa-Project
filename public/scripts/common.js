...
document.addEventListener('DOMContentLoaded', async () => {
  // Authen user
  const respAuthen = await authenticated();

  if (respAuthen.status === 'success') {
    ...
    if (activeMenuItem) {
      ...
      switch (menuId) {
        ...
        case 'menu-applications':
          ...
          display_mainContent_applications(result);
          break;
        case 'menu-tutorial':
          // nothing
          break;
      ...
      menuItem.addEventListener('click', () => {
        ...
        switch (menuId) {
          case 'menu-mainDashboard':
            ...
            break;
          case 'menu-deviceProfiles':
            window.location.href = "../htmls/deviceProfiles.html";
            break;
          case 'menu-applications':
            window.location.href = "../htmls/applications.html";
            break;
          case 'menu-tutorial':
            window.location.href = "../htmls/tutorialPage.html";
            break;
          case 'menu-logout':
            localStorage.clear();
...
function display_mainContent_deviceProfiles(gets) {
  ...
  for (const device of gets.resultList) {
...
function display_mainContent_applications(gets) {
  ...
  let count = 0;
  gets.resultList.forEach(function (item, index) {
...
async function authenticated() {
  ...
  localStorage.setItem('user_un', result.user_un);
